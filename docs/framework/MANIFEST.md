...
| `features/`, `heroes/`, `stats/`, `testimonials/`, `faq/`, `pricing/`, `integrations/`, `auth/`, `ai/`, `backgrounds/`, `tables/`, `ui/`, `navigation/`, `text/` | One self-contained `.tsx` block per file, registry in README | 8, 9, 13 |
...
| `09_design_direction_template.md` | Template for resolved visual identity — direction, typography, palette, signature moves, internal inheritance | 2 |
