...
/**
 * Block: Avatar picker — onboarding profile-setup card: animated avatar stage with
 * per-avatar color ring, thumbnail strip with check badge, validated username field
 * with live character count. Pairs with the onboarding flow (02_auth_and_onboarding).
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v2.0.0.
 * Reduced-motion support is built in — keep it. PLACEHOLDER: the four inline SVG
 * avatars + AVATAR_RGB ring colors — swap for the product's avatar set (or generate
 * via DiceBear) and retheme rings to direction accents. Wire onComplete to the real
 * profile mutation.
 */
