// Block: Integrations grid — centered heading with 6-up logo cards and Learn More CTAs.
// Source: 21st.dev community. Adapt: only integrations the product REALLY has (honest-proof
// rule), real brand SVGs, real links, restyle per docs/project/09_design_direction.md.
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-6">
              Replace with one sentence on why these connections matter for this product.
            </p>
          </div>

          <div className="mt-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <IntegrationCard title="GitHub" description="Version control and collaboration platform for developers.">
              <GitHubLogo />
            </IntegrationCard>

            <IntegrationCard title="Slack" description="Team communication and collaboration hub.">
              <SlackLogo />
            </IntegrationCard>

            <IntegrationCard title="Notion" description="All-in-one workspace for notes, tasks, and projects.">
              <NotionLogo />
            </IntegrationCard>

            <IntegrationCard title="Figma" description="Collaborative design and prototyping platform.">
              <FigmaLogo />
            </IntegrationCard>

            <IntegrationCard title="Discord" description="Voice, video, and text chat platform for communities.">
              <DiscordLogo />
            </IntegrationCard>

            <IntegrationCard title="VS Code" description="Lightweight but powerful source code editor.">
              <VSCodeLogo />
            </IntegrationCard>
          </div>
        </div>
...
// PLACEHOLDER logos — replace with the official brand SVGs of the product's real integrations
const GitHubLogo = () => (
...
const NotionLogo = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="text-gray-900 dark:text-gray-100">
