...
/**
 * Block: Profile dropdown — user card trigger (name, email, gradient-ring avatar,
 * bending-line indicator) opening a rounded menu with value badges (plan, model)
 * and a danger sign-out row. App-shell top bar user menu.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT).
 * Import fixes applied: the source imported a Gemini logo from `../icons/gemini` —
 * stubbed with lucide Sparkles. PLACEHOLDER: SAMPLE_PROFILE_DATA, avatar URL, menu
 * items, and the purple/pink gradient ring — feed from the real session user and
 * retheme to direction tokens. Needs shadcn dropdown-menu.
 */
...
// PLACEHOLDER stub for the source's Gemini logo import — swap for the real
// provider mark if the menu surfaces a model row
