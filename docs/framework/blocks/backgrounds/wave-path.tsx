// Block: Wave path — a hairline that bends elastically under the cursor and springs back.
// Source: 21st.dev community. A direction-appropriate divider/hero accent (Editorial/Organic).
// Desktop pointer interaction only — renders as a static line on touch/reduced-motion.
'use client';
