...
/**
 * Block: Smooth drawer — bottom drawer (vaul via shadcn drawer) whose content
 * staggers in with spring variants; demo body is a purchase/upgrade card with
 * price tag and shimmer CTA. Upgrade prompts, confirmation sheets, mobile actions.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v1.0.0.
 * Needs the shadcn drawer primitive (`pnpm dlx shadcn@latest add drawer`).
 * PLACEHOLDER: title/description/prices, /logo.svg, the kokonutui.pro link, and
 * the rose/pink CTA gradient — retheme to the direction's accent; CTA shimmer
 * counts against the restraint budget.
 */
