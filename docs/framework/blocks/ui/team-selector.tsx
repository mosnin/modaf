...
/**
 * Block: Team selector — stepper that grows/shrinks an overlapping avatar stack
 * with spring pop-in, animated rolling counter, and a shake at the limits.
 * Onboarding team-size questions, seat selection in billing flows.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v3.0.0.
 * Reduced-motion support is built in — keep it. PLACEHOLDER: DEFAULT_MEMBERS use
 * DiceBear's external avatar API — swap for real member data (or keep DiceBear and
 * add api.dicebear.com to image domains; `unoptimized` is set so it works without).
 */
