...
/**
 * Block: File upload — drag-and-drop zone with animated SVG illustration, size/type
 * validation, simulated progress (rainbow ring), and error toasts. Upload steps in
 * onboarding, settings, and content features.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v1.0.0.
 * The upload is SIMULATED (uploadDelay timer) — wire onUploadSuccess to the real
 * uploader (default stack: uploadthing) and drive `progress` from actual events.
 * Retheme: the multicolor progress ring and blue accents to the direction's
 * palette (the rainbow ring reads playful — tone down for serious directions).
 */
