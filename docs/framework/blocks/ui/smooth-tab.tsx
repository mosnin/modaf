...
/**
 * Block: Smooth tab — bottom tab toolbar with a spring-sliding active pill and a
 * card area whose content slides/blurs in from the travel direction. Segmented
 * content switchers inside feature sections or settings panels.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v1.0.0.
 * Caveats: the default card waveform builds classes dynamically (`fill-${color}`)
 * which Tailwind won't generate — safelist them or pass static classes when
 * changing colors; supply `cardContent` for real use. PLACEHOLDER: DEFAULT_TABS
 * and the #1F9CFE fallback accent. Tab strip is fixed w-[400px] + grid-cols-4 —
 * adjust to the real tab count.
 */
