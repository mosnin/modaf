// Block: Menu toggle — hamburger ↔ arrow morph via stroke-dashoffset, pure CSS transition.
// Source: 21st.dev community. Pairs with the mobile nav sheet (01_app_shell.md).
'use client';
