...
/**
 * Block: Animated toolbar — icon toolbar where the selected tool expands to show its
 * label (spring width morph) with a transient "clicked" notification pill, plus a
 * lock/edit toggle. Editor headers and canvas tool rails.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v1.0.0.
 * PLACEHOLDER: DEFAULT_TOOLBAR_ITEMS (derive from the product's real tools) and the
 * hardcoded #1F9CFE blue (swap for the direction's accent). The demo notification
 * pill ("X clicked!") is demo-only — remove when wiring real handlers via onSelect.
 */
