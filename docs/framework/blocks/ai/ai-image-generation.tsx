// Block: AI image generation reveal — shimmer status text + progressive blur-unveil over the
// generated image. Source: 21st.dev community. Wire `progress`/state to real generation
// events instead of the simulated timer when integrating.
"use client"
