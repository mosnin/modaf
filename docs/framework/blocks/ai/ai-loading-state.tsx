...
/**
 * Block: AI loading state — agent "working" indicator: spinning multicolor progress
 * ring + auto-scrolling numbered task log with gradient fade. Long-running AI/agent
 * operations (tool loops, research runs) where a plain spinner undersells the work.
 * Source: KokonutUI (kokonutui.com, @kokonutui, MIT), v1.0.0.
 * PLACEHOLDER: TASK_SEQUENCES are demo copy — drive lines from REAL streamed agent
 * status events (23_ai_module.md), never fabricate steps that aren't happening.
 * Retheme the rainbow ring to the direction's palette.
 */
