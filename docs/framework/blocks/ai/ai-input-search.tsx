...
/**
 * Block: AI input search — auto-resizing textarea composer with attach button and
 * an animated web-search toggle (rotating globe + expanding label). AI assistant
 * composers where a search/grounding mode exists.
 * Source: KokonutUI (kokonutui.com, @kokonutui, MIT), v1.0.0.
 * Import fixes applied: `@/hooks/use-auto-resize-textarea` inlined below.
 * PLACEHOLDER: sky accent (retheme to direction), file input is unwired — connect
 * onSubmit/attachments to the assistant route (23_ai_module.md).
 */
