...
/**
 * Block: Dynamic text — rapid-fire vertical word swap (300ms cadence) that settles
 * on the final word; the classic multilingual-greeting intro beat. Onboarding
 * welcome screens and the post-login preloader's greeting moment.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v1.0.0.
 * PLACEHOLDER: greetings list — swap for product-relevant words (or keep greetings
 * for a welcome beat). Plays once then stops — keep it that way; add a
 * prefers-reduced-motion guard (skip straight to the final word) when integrating.
 */
