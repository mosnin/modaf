...
/**
 * Block: Scroll text — scrollable word list where the centered item highlights via
 * IntersectionObserver, entering with alternating slide/rotate. Tech-stack or
 * capability showcases inside a feature section.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v1.0.0.
 * Counts as a scroll-choreography moment — one per page (signature_interactions.md).
 * PLACEHOLDER: texts list. Retheme highlight colors to direction tokens.
 */
