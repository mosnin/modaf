...
/**
 * Block: Typewriter title — multi-sequence typewriter with natural typing variance
 * (hesitations/bursts), delete-and-retype, and blinking caret.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v1.0.0.
 * BANNED-DEFAULT ADJACENT: typewriter hero headlines are banned default #10 when
 * they're the page's only motion idea. Vetted ONLY for Terminal/Industrial-direction
 * sites where monospace typing IS the identity, or inside a product demo that types
 * for a reason — never as a generic hero garnish. PLACEHOLDER: DEFAULT_SEQUENCES.
 */
