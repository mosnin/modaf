// Block: FAQ two-column — editorial left-heading layout with dashed-divided rich answers.
// Source: 21st.dev community. Good for directions that avoid accordions (Editorial, Swiss).
// Adapt: real objections only, replace all copy, restyle per docs/project/09_design_direction.md.
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="grid gap-y-12 px-2 lg:[grid-template-columns:1fr_auto]">
          <div className="text-center lg:text-left">
            ...
            <p>Replace with one supportive line.</p>
          </div>
