// Block: FAQ accordion — centered heading with a carded accordion list and support link.
// Source: 21st.dev community. Adapt: replace questions/answers with THIS product's real
// objections (never invent filler questions — see site_composition.md honest-proof rule),
// point the support link at a real route, restyle per docs/project/09_design_direction.md.
'use client'
