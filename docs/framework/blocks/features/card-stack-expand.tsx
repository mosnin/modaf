// Block: Expandable card stack — fanned deck of product/feature cards that spreads
// open on click (spring stagger), with spec rows, imagery, and split-color titles.
// Good as an interactive feature/plan showcase on marketing pages.
// Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT). Reduced-motion support is
// built in (rotation removed, tween instead of spring) — keep it.
// PLACEHOLDER content: the products array, Unsplash/undraw images (swap for REAL
// product imagery), and all spec values. Retheme before shipping: the white/60 +
// backdrop-blur card surface is one repetition away from the banned glassmorphism
// card grid — resolve surfaces to the direction's card tokens, and keep this as the
// page's single interactive moment rather than one of several stacked effects.
"use client";
