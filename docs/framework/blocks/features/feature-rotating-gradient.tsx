// Block: Rotating gradient feature — conic-gradient glow spinning behind a floating status
// card, beside copy + link. Source: 21st.dev community (rotating-gradient-right).
// NOTE: full-spectrum conic glow — check the design direction's banned-defaults before using;
// retheme the gradient stops to the direction's palette. Replace all copy.
"use client";
...
export default function FeatureRotatingGradient() {
  return (
    <section className="min-h-screen w-full bg-white dark:bg-black text-black dark:text-white px-8 py-16 md:px-16">
      <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
        <div className="relative mx-auto flex h-[40rem] w-full max-w-[60rem] items-center justify-center overflow-hidden rounded-3xl">
          {/* Rotating conic gradient glow — retheme stops to the direction's palette */}
          ...
          <Card className="w-[340px] z-10 rounded-2xl border border-white/10 bg-black/85 shadow-2xl backdrop-blur-xl">
            <CardContent className="p-5">
              <div className="mb-3 flex items-center justify-between">
                <span className="text-sm font-medium">Replace product name</span>
              ...
              <p className="text-xs text-zinc-400">
                Replace with believable in-product status copy.
              </p>
        ...
        <div className="space-y-4">
          <h2 className="text-lg sm:text-xl lg:text-3xl font-normal text-gray-900 dark:text-white leading-relaxed">
            ...
            <span className="text-gray-500 dark:text-gray-400 text-sm sm:text-base lg:text-3xl">Replace with the supporting value sentence in muted tone.</span>
          </h2>
          <Button variant="link" className="px-0 text-black dark:text-white">
            Replace CTA <ArrowRight />
          </Button>
        </div>
      </div>
    </section>
