...
/**
 * Block: Carousel cards — horizontally scrolling snap rows of media cards (image,
 * badge, favorite button, rating, price) with arrow controls. Marketplace/browse
 * surfaces: listings, templates, experiences, catalog rows.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v1.0.0.
 * PLACEHOLDER content: all items, Unsplash images, and prices — feed from the
 * product's real entities. Add Unsplash (or the product's CDN) to next.config
 * image domains, or swap to local assets. Card fields adapt to the entity shape.
 */
