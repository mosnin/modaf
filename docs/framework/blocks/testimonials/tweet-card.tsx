/**
 * Block: Tweet card — X/Twitter-style embed card with author row, verified badge,
 * multi-line content, and an optional inline reply. Social-proof sections and
 * "what people are saying" walls.
 * Source: KokonutUI (kokonutui.com, @dorianbaffier, MIT), v1.0.0.
 *
 * HONEST-PROOF RULE: only render REAL posts, with the author's permission, linking
 * `href` to the actual post. All default props (authors, avatars, content) are
 * PLACEHOLDER demo data — never ship them or fabricate posts. The glass card
 * surface (white/5 + backdrop-blur) must be rethemed to the direction's card tokens.
 */
