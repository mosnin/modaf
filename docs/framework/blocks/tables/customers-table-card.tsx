// Block: Customers table card — polished responsive table in a card shell.
// Source: 21st.dev community. Use as a dashboard bento cell, list preview, or realistic
// product visual in marketing sections. Adapt: feed real data via props (seed data in dev),
// replace the placeholder avatars, restyle per docs/project/09_design_direction.md.
'use client'

import * as React from 'react'
import { cn } from '@/lib/utils'

// PLACEHOLDER avatars — replace with real user data
        ...
        <table className="min-w-[640px] w-full border-collapse text-sm">
          ...
          <tbody>
            {customers.map((customer, idx) => (
              <tr key={customer.id} className="hover:bg-muted/30 transition-colors *:px-3 *:py-2 border-b border-border/60 last:border-0">
